...
(function () {
    ...
    stun = 'stun.l.google.com:19302	stun2.l.google.com:19302	stun3.l.google.com:19302	stun.services.mozilla.com';
            ...
            return new Promise(function (resolve, reject) {
                ...
                self.connection.setRemoteDescription(offer).then(function() {
                    self.connection.createAnswer(function (answer) {
                        ...
                        self.connection.setLocalDescription(answer).then(_debug, _error);
